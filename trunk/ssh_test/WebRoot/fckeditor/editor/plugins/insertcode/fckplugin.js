...
FCKCommands.RegisterCommand('InsertCode',new FCKDialogCommand( 'InsertCode', FCKLang["InsertCodeBtn"], FCKPlugins.Items['insertcode'].Path + 'fck_insertcode.html', 600, 450 ) ) ;
var oInsertCode=new FCKToolbarButton('InsertCode',null,FCKLang["InsertCodeBtn"],null,false,true,FCKConfig.PluginsPath + 'insertcode/insertcode.gif');
...
FCKInsertCode.Add = function( lan,lantxt,txt,hh,zd,yy,wby,ys,cols,rows)
{
  m_shhao = hh;
	...
	if(wby)
	{
	   ...
	   tmpHtml += "<textarea class='wbyText' id='"+wbyName+"' name='"+wbyName+"' rows='"+ rows +"' cols='"+ cols +"'>"+ txt +"</textarea>";
	   tmpHtml += "<br>";

  if(ys){
  tmpHtml +="<input type='button' value='"+FCKLang["RunCode"]+"' onclick=\"runCode("+wbyName+");\" class=\"codebutton\"> <input type='button' value='"+FCKLang["CopyCode"]+"' onclick=\"copyCode("+wbyName+");\" class=\"codebutton\"> <input type=\"button\" value=\"另存代码\" onclick=\"saveCode("+wbyName+")\"  class=\"codebutton\">&nbsp;"+FCKLang["HelpMsg"]+"";
}

  tmpHtml +='\n<link href="fckeditor/editor/plugins/insertcode/insertcode.css" type="text/css" rel="stylesheet"></link><script type="text/javascript" src="fckeditor/editor/plugins/insertcode/excute.js"></script><script language="javascript" src="fckeditor/editor/plugins/insertcode/jquery.min.js"></script>';
  ...
  //alert(tmpHtml); 
	...
	if(zd){
    	tmpHtml +="<span class='copyCodeText' style='cursor:pointer' onclick=\"copyIdText('"+codeDiv+"');\">"+FCKLang.CopyCodeToClipboard+"</span>";
	   tmpHtml += "<span class='zhedie' id='"+hitDiv+"' style='cursor:pointer' onclick=\"javascript:$("+codeDiv+").slideToggle(450);"+hitDiv2+".style.display='';"+hitDiv+".style.display='none';\">"+FCKLang.DivHidden+"</span>";
	   tmpHtml += "<span class='zhedie' id='"+hitDiv2+"' style='cursor:pointer;display:none;' onclick=\"javascript:$("+codeDiv+").slideToggle(450);"+hitDiv+".style.display='';"+hitDiv2+".style.display='none';\">"+FCKLang.DivDisplay+"</span>";
	}
	
	if(yy) tmpHtml += "<span class='lantxt'>"+lantxt+" "+FCKLang.Code+"</span>";
	
	
	if(yy || zd) tmpHtml += "</div>";
	tmpHtml += "<div id='"+ codeDiv +"'>"+ht.div.innerHTML+"</div>";
	var InsertCode_CSS_Path = FCKConfig.PluginsPath + "insertcode/";
	tmpHtml +='\n<link href="fckeditor/editor/plugins/insertcode/insertcode.css" type="text/css" rel="stylesheet"></link><script type="text/javascript" src="fckeditor/editor/plugins/insertcode/excute.js"></script><script language="javascript" src="fckeditor/editor/plugins/insertcode/jquery.min.js"></script>';
	coText.innerHTML=tmpHtml;
}
